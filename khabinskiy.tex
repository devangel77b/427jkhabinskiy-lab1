...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[RE,RO]{J S\&E \textbf{2}, 30--35 (2026)}
\fancyhead[LO]{Khabinskiy \emph{et al}}
\fancyhead[LE]{Investigation of freefall}
\fancyfoot[C]{\thepage}
\fancypagestyle{mytitlepage}{
\fancyhf{}
\fancyhead[C]{Journal of Science \& Engineering \textbf{2}, 30--35 (2026)}
\fancyfoot[C]{\thepage}
}
...
Galileo's claim of objects falling with the same constant acceleration independent of their mass is presented in \citet{galilei:1638:discourses}. This directly contradicted the Aristotelian view that a heavy body falls faster than a lighter one \cite{aristotle}. In Galilean free fall, acceleration is constant and uniform, and the time required for an object to fall from rest depends only on the height and gravitational acceleration, not on the object's mass. 
