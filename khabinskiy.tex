...
\begin{figure}
\begin{center}
\includegraphics[width=0.33\columnwidth]{figures/image4.jpg}
\includegraphics[width=0.33\columnwidth]{figures/image3.png}
\end{center}
\caption{Bottles of rocks and water used in the experiment. 8 in by 2.5 in. Needs scale bar. Drop setup from the window to the ground. Are these both in here? This figure is not cited anywhere in the text.}
\label{fig:1}
\end{figure}
...
\section{Results}
Fill in later. There appears to be a table and a figure.
\begin{table}
